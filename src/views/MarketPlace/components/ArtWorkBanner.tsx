...
import { Input, Flex } from '@spacegrimeswap/uikit'
      ...
      <Wrapper>
        ...
        <SearchPanel>
          ...
          <RightWrapper>
            ...
            <ButtonGroup>
              <CustomButton backgroundColor="#fa1dbb">HOTTEST</CustomButton>
              <CustomButton backgroundColor="#414076">LATEST</CustomButton>
              <CustomButton backgroundColor="#0095ff">OLDEST</CustomButton>
            </ButtonGroup>
            <SortDetail>

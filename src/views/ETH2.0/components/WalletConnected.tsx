...
const cards = [
  "/images/ether2/img_1.png",
  "/images/ether2/img_2.png",
  "/images/ether2/img_3.png"
];
              ...
              <div style={{ width: '50%', marginRight: 'auto', marginLeft: 'auto', display: 'block' }}>
                <div>
                  <Flex style={{ display: 'inline-flex' }}>
                    {count === 0 || count === 2 ? (<img src={cards[1]} style={{ zIndex: 0, marginRight: '-20px', width: '170px', height: '170px', opacity: '0.3' }} alt="carousel-img" />) : (<img src={cards[count + 1]} style={{ zIndex: 0, marginRight: '-20px', width: '170px', height: '170px', opacity: '0.3' }} alt="carousel-img" />)}

                    <img src={cards[count]} style={{ zIndex: 0, marginLeft: '-70px', width: '170px', height: '170px' }} alt="carousel-img" />
                  </Flex>
                </div>
